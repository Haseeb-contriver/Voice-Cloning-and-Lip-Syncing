"""
Django settings for voice_cloning_lip_syncing project.
...
SECRET_KEY = 'django-insecure-)cwd_3h8ql0umarq6d@4*g8&m$_&@dd$__n5u^lkvcdt+z3q5)'
...
ROOT_URLCONF = 'voice_cloning_lip_syncing.urls'
...
WSGI_APPLICATION = 'voice_cloning_lip_syncing.wsgi.application'
